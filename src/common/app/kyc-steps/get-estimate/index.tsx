...
const AgentPremiumCalculatorComponent = () => {
  ...
  const { savedSubscriberInfo, setSavedSubscriberInfo } =
      ...
      <div className={"p-8 grid grid-cols-12 gap-8"}>
        ...
        >
          ...
          <input
            ...
            onChange={(e) => {
              setStates({ ...states, plan: e.target.value });
        ...
        <div className={"col-span-12"}>
          <FormCheckboxComponent
            ...
            onChange={() => {
              ...
              setSavedSubscriberInfo({
                ...savedSubscriberInfo,
                hasExcessBuyBack: states.excessBuyBack === true ? false : true,
              });
            }}
          />
        </div>
...
export default AgentPremiumCalculatorComponent;
